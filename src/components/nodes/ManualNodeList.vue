...
<template>
  ...
  >
    ...
    <div v-if="node.group" class="shrink-0 w-auto min-w-[60px] max-w-[120px] px-1">
      <div 
        class="text-[10px] text-center font-medium px-1.5 py-0.5 misub-radius-md bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 truncate cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" 
        :title="node.group"
    ...
    <div v-else class="shrink-0 w-0"></div>
